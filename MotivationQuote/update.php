...
<div class="maincontainer">
    ...
    <form action="" method="post" style="margin: 5vw;">
        <input type="hidden" name="motiquoteid" value="<?= $id; ?>" />

        <div class="form-group">
            <label for="quote">Sentence</label>
            <input type="text" class="form-control" name="quote" id="quote" value="<?= $upquote; ?>"
                   placeholder="<?= $upquote; ?>">
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" name="category" id="category" value="<?= $upcategory; ?>"
                   placeholder="">
            <span style="color: red">
