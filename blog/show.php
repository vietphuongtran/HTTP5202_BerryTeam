...
<form action="" method="post">
    ...
    <input type="text" id="title" name="post[title]" value="<?= $title; ?>"/><br/>

    <label for=content">Content</label></br>
    <textarea id="content" name="post[content]" rows="20" cols="50" value="<?= $content; ?>"></textarea><br/>
